...
import './App.css'
import thymeTooCookLogo from './assets/thyme-to-cook-logo.png'
...
Focus on recipes that use most of the available ingredients and are practical to make with the listed tools.`
  ...
  return (
    <div className="min-h-screen app-container" style={{ zoom: `${zoomLevel}%` }}>
      ...
      <div className="relative z-10 container mx-auto px-4 py-12">
        <div className="hero-section">
          <div className="logo-container mb-6">
            <img 
              src={thymeTooCookLogo} 
              alt="Thyme to Cook Logo" 
          ...
          <div className="settings-panel">
            <div className="zoom-controls">
              <label className="zoom-label">Text Size:</label>
              <div className="zoom-buttons">
                <button 
                  onClick={() => handleZoomChange(Math.max(75, zoomLevel - 25))}
                  className="zoom-btn"
                ...
                <button 
                  onClick={() => handleZoomChange(Math.min(150, zoomLevel + 25))}
                  className="zoom-btn"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {currentView === 'recipes' && (
            <>
              ...
              <button
                className="premium-button mb-8 max-w-xs mx-auto block"
